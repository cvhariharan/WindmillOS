...
kernel.o: src/arch/x86/kernel.c src/arch/x86/drivers/vga.c src/arch/x86/lib/gdt/gdt.c src/arch/x86/lib/idt/idt.c
	gcc -m32 -g -c src/arch/x86/kernel.c -o build/kernel.o -nostdlib
	gcc -m32 -g -c src/arch/x86/drivers/vga.c -o build/vga.o -nostdlib
	gcc -m32 -g -c src/arch/x86/lib/gdt/gdt.c -o build/gdt.o
	nasm -f elf32 -g src/arch/x86/lib/gdt/gdt.asm -o build/gdt_asm.o
	gcc -m32 -g -c src/arch/x86/lib/idt/idt.c -o build/idt.o
	gcc -m32 -g -c src/arch/x86/lib/idt/isr.c -o build/isr.o
